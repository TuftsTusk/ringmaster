...
function getListingSchema(name) {
    var listing_type = listing_name_map[name];
    return listing_type.schema;
    // return listing_objs[listing_type].schema;
}
...
function findListingByIDAndUserID(listing_id, user_id, callback){
  listing.model.findOne({_id: listing_id, user_id: user_id}, callback);
}
exports.findListingByIDAndUserID = findListingByIDAndUserID;

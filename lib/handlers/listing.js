...
function getListings(listing_type, pageNum, callback) {
    var params = {
    ...
    if (listing_type == 'SubletListing'){
        ...
        listing.model.paginate(params, { page: pageNum, limit: Consts.LISTINGS_PER_PAGE, sort:{lastRefreshed: 'desc'}}, function(err, result){

            var listings = result || [];
            callback(err, listings.docs || [])
        })
    }

...
var mailOpts = {
    ...
    secure: true,
    auth: {
        user: process.env.UTILCONTACTEMAILADDRESS,
        pass: process.env.UTILCONTACTEMAILPASSWORD
    }
};
...
exports.contactSeller = function(host, from, to, message, listingId, cb) {
  // setup e-mail data with unicode symbols
  var mailOptions = {
      from: '"pleasereply" <pleasereply@tuskmarketplace.com>', // sender address
      replyTo: from,
      to: to, // list of receivers
      subject: 'New Message on Your Item', // Subject line
      text: message,
      html: '<div>'+message+'</div><br>===============<br>Please reply to this email to contact the interested party <br><a href='+host+'/#/listing/'+listingId+'>View original listing on Tusk Marketplace</a>' // html body
       // plaintext body
  };
  // send mail with defined transport object

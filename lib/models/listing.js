...
photoSchema.methods.toSecure = function(roles) {
    ...
    photoSchema.eachPath(function(path, schemaType) {
        ...
        if ("reqd_role" in schemaType.options && consts.checkPriv(roles, schemaType.options.reqd_role)) {
...
miscSchema.methods.toSecure = function(roles, user_id) {
    var ret_obj = {};
    var list = this;
    ...
    if ("user_id" in list && user_id && user_id == list.user_id) {
...
bookSchema.methods.toSecure = function(roles) {
    var ret_obj = {};
    var list = this;
    bookSchema.eachPath(function(path, schemaType) {
        //if ((!("reqd_role" in schemaType.options) && path[0] !=  '_')
        //    || consts.checkPriv(roles, schemaType.options.reqd_role)) {
        if ("reqd_role" in schemaType.options && consts.checkPriv(roles, schemaType.options.reqd_role)) {
            utils.setValueByPath(ret_obj, path, utils.getValueByPath(list, path)); 
...
bedroomSchema.methods.toSecure = function(roles) {
    var ret_obj = {};
    var list = this;
    bedroomSchema.eachPath(function(path, schemaType) {
        //if ((!("reqd_role" in schemaType.options) && path[0] !=  '_')
        //    || consts.checkPriv(roles, schemaType.options.reqd_role)) {
        if ("reqd_role" in schemaType.options && consts.checkPriv(roles, schemaType.options.reqd_role)) {
            utils.setValueByPath(ret_obj, path, utils.getValueByPath(list, path)); 
...
subletSchema.methods.toSecure = function(roles) {
    var ret_obj = {};
    var list = this;
    subletSchema.eachPath(function(path, schemaType) {
        //if ((!("reqd_role" in schemaType.options) && path[0] !=  '_')
        //    || consts.checkPriv(roles, schemaType.options.reqd_role)) {
        if ("reqd_role" in schemaType.options && consts.checkPriv(roles, schemaType.options.reqd_role)) {
            utils.setValueByPath(ret_obj, path, utils.getValueByPath(list, path)); 
...
furnitureSchema.methods.toSecure = function(roles) {
    var ret_obj = {};
    var list = this;
    furnitureSchema.eachPath(function(path, schemaType) {
        //if ((!("reqd_role" in schemaType.options) && path[0] !=  '_')
        //    || consts.checkPriv(roles, schemaType.options.reqd_role)) {
        if ("reqd_role" in schemaType.options && consts.checkPriv(roles, schemaType.options.reqd_role)) {
            utils.setValueByPath(ret_obj, path, utils.getValueByPath(list, path)); 

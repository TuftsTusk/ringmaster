...
var FURNITURE_MANUFACTURER_LEN_MIN = 1;
var FURNITURE_MANUFACTURER_LEN_MAX = 5000;
...
var furnitureSchema = new Schema({
    ...
    description: {
        ...
        validate: {
            ...
            message: '{VALUE} is not a valid furniture description'
        },
        reqd_role: consts.ROLE_INVALID
    },
    title: {
        ...
        validate: {
            ...
            message: '{VALUE} is not a valid furniture title'
        },
        reqd_role: consts.ROLE_INVALID
    },
    condition: {
        ...
        validate: {
            ...
            message: '{VALUE} is not a valid furniture condition'
        },
        reqd_role: consts.ROLE_INVALID
    },
    dimensions: {
    ...
    model_info: {
        manufacturer: {
            ...
            validate: {
                validator: function(v) {
                    return (typeof(v) === 'string' &&
                        v.length >= FURNITURE_MANUFACTURER_LEN_MIN &&
                        v.length <= FURNITURE_MANUFACTURER_LEN_MAX);
                },
                message: '{VALUE} is not a valid furniture manufacturer'
            },
            reqd_role: consts.ROLE_INVALID
        },
        model_name: {
            ...
            validate: {
                ...
                message: '{VALUE} is not a valid furniture model name'
            },
            reqd_role: consts.ROLE_INVALID
        }
    },

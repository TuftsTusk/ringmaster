...
exports.getListing = function(request, response) {
    ...
    return listingHandler.getListingsBySearch(request.query.search, listing_type, function(err, listings) {
        if (err) {
...
exports.putListingVisibilityById = function(request, response) {
    ...
    listingHandler.putListingVisibilityByID(uid, visible, function(err) {
